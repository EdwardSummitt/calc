              ...
              Center(
                child: ConstrainedBox(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                  _button('AC', onPressed: _clear, kind: _ButtonKind.utility),
                  _button('+/-', onPressed: _toggleSign, kind: _ButtonKind.utility),
                  _button('%', onPressed: _percent, kind: _ButtonKind.utility),
                  _button('÷', onPressed: () => _chooseOperation('÷'), kind: _ButtonKind.operator),
                  _button('7', onPressed: () => _input('7')),
                  _button('8', onPressed: () => _input('8')),
                  _button('9', onPressed: () => _input('9')),
                  _button('x', onPressed: () => _chooseOperation('x'), kind: _ButtonKind.operator),
                  ...
                  _button('=', onPressed: _calculate, kind: _ButtonKind.equals),
                    ],
                  ),
                ),
              ),
